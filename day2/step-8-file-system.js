...
fs.writeFile("temp.txt",data+" : \n written at "+new Date().getUTCMilliseconds(),function(){
    console.log("inside the fs callback ", new Date().getUTCMilliseconds())
});
console.log("outside the fs callback ", new Date().getUTCMilliseconds()); 
// read file
// delete file